...
DROP TABLE IF EXISTS operator_payouts CASCADE;
DROP TABLE IF EXISTS match_registrations CASCADE;
DROP TABLE IF EXISTS matches CASCADE;
DROP TABLE IF EXISTS operator_applications CASCADE;
DROP TABLE IF EXISTS operators CASCADE;
DROP TABLE IF EXISTS subscriptions CASCADE;
DROP TABLE IF EXISTS publish_payments CASCADE;
DROP TABLE IF EXISTS match_stats CASCADE;
DROP TABLE IF EXISTS event_applications CASCADE;
DROP TABLE IF EXISTS events CASCADE;
DROP TABLE IF EXISTS academy_registrations CASCADE;
DROP TABLE IF EXISTS academy_sessions CASCADE;
...
DROP TYPE IF EXISTS publish_payment_status_enum CASCADE;
DROP TYPE IF EXISTS match_quality_enum CASCADE;
...
-- Remove old buckets (ignore errors)
DELETE FROM storage.buckets WHERE id IN ('avatars', 'structure-photos', 'terrain-photos', 'documents', 'match-images', 'chat-images', 'chat-voice-notes');
...
INSERT INTO storage.buckets (id, name, public) VALUES ('chat-voice-notes', 'chat-voice-notes', true);
