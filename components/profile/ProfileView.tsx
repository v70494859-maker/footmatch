...
export default function ProfileView({
  ...
  return (
    <div className="px-4 py-6 max-w-2xl mx-auto space-y-6">
      ...
      <Link
        href="/faq"
        className="flex items-center justify-between bg-surface-900 border border-surface-800 hover:border-surface-700 rounded-xl px-4 py-3 transition-colors"
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-foreground">{t.faq.title}</span>
        </div>
