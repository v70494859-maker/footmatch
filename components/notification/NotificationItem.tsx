...
const colorByType: Record<NotificationType, string> = {
  match_created: "text-pitch-400",
  registration_confirmed: "text-pitch-400",
  registration_canceled: "text-amber-500",
  match_canceled: "text-danger-500",
  match_full: "text-amber-500",
  subscription_activated: "text-pitch-400",
  subscription_canceled: "text-danger-500",
  application_approved: "text-pitch-400",
  application_rejected: "text-danger-500",
  payout_completed: "text-pitch-400",
  match_results_available: "text-blue-400",
  match_mvp: "text-amber-400",
  xp_earned: "text-pitch-400",
  level_up: "text-amber-400",
  badge_unlocked: "text-amber-400",
  friend_request: "text-blue-400",
  friend_accepted: "text-pitch-400",
  team_invite: "text-blue-400",
  team_joined: "text-pitch-400",
  challenge_received: "text-amber-500",
  challenge_accepted: "text-pitch-400",
  challenge_declined: "text-danger-500",
  new_message: "text-blue-400",
  post_liked: "text-danger-500",
  post_commented: "text-blue-400",
};
  ...
  return (
    <button
      ...
      className={`w-full text-left flex gap-3 px-4 py-3 transition-colors ${
        read ? "opacity-60" : "bg-surface-900"
      }`}
    >
      <div className={`shrink-0 mt-0.5 ${colorByType[type]}`}>
        {iconByType[type]}
      </div>
      <div className="min-w-0 flex-1">
        <div className="flex items-start gap-2">
          ...
          {!read && (
            <span className="w-2 h-2 rounded-full bg-pitch-500 shrink-0 mt-1.5" />
          )}
        </div>
        <p className="text-xs text-surface-500 line-clamp-2 mt-0.5">{body}</p>
