...
export default function PostCard({ post, currentUserId, onReactionChange, onLikeToggle, onCommentAdded }: PostCardProps) {
  ...
  const handleReactionChange = (postId: string, reaction: PostReactionType | null) => {
    if (onReactionChange) {
      ...
      // Backward compat: treat any reaction as "liked"
      onLikeToggle(postId, reaction !== null);
    }
  };
  ...
  return (
    <div className="bg-surface-900 border border-surface-800 rounded-2xl overflow-hidden">
      ...
      {/* Poll */}
      {post.post_poll && (
        <PostPoll poll={post.post_poll} currentUserId={currentUserId} />
      )}
