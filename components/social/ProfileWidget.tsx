    ...
    <div className="sticky top-4 space-y-4">
      ...
      <div className="bg-surface-900 border border-surface-800 rounded-2xl overflow-hidden">
        ...
        <div className="grid grid-cols-3 divide-x divide-surface-800">
          ...
          >
            ...
            <span className="text-xs text-surface-500">{t.social.profileWidget.friends}</span>
          </Link>
          ...
          >
            ...
            <span className="text-xs text-surface-500">{t.social.profileWidget.teams}</span>
          </Link>
        </div>
      </div>
      ...
      <div className="bg-surface-900 border border-surface-800 rounded-2xl overflow-hidden">
        ...
        >
          ...
          <span className="text-sm text-surface-50 flex-1">{t.social.profileWidget.friends}</span>
          {pendingRequests > 0 && (
        ...
        >
          ...
          <span className="text-sm text-surface-50 flex-1">{t.social.messages.title}</span>
          {unreadMessages > 0 && (
            <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-pitch-400 text-surface-950 text-xs font-bold flex items-center justify-center">
              {unreadMessages}
            </span>
